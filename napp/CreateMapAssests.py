...
def main():
    yamlPath = "/home/ipb-hk/harmony_nmcl/ncore/data/ABB_lab/0/GMap.yaml"
    roomnum = 1
    ...
    # yamlPath = "/home/ipb-hk/harmony_nmcl/ncore/data/floor/Bonn/0/FMap.yaml"
    # roomnum = 1
    # roomsegName = "roomseg.png"
    # classes = ['door', 'table', 'pillar']
    # categories = ["laboratory"]
